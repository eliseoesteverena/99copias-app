...
import { calcularPrecioFotos } from './lib/precio-fotos.js';
...
export async function onRequestPost({ request, env }) {
  try {
    ...
    const resultado = body.categoria === 'fotos'
      ? await calcularPrecioFotos(env.DB, body.archivos, body.categoria)
      : await calcularPrecio(env.DB, body.archivos, body.categoria);
