...
document.getElementById('btnConfirmarTransferencia').addEventListener('click', async () => {
  ...
  try {
    ...
    if (comprobanteSeleccionado) {
      ...
      if (!res.ok) {
        // El pedido ya se creó — no cortamos el flujo por esto, el cliente
        // puede subir el comprobante después desde "Mis pedidos".
    ...
    // Reusa la misma pantalla de resultado que ya existe para "pendiente"
    // (MP por QR/efectivo) — el texto ya contempla transferencia también.
